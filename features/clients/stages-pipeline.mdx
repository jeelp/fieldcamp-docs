...
For other view options (table, grouped), see the [Client List & Views](/features/clients/client-list) guide.
...
**Option 2: [Client detail page](/features/clients/client-detail)**
- Click the stage badge
- Select new stage from dropdown
- Click **Update**

**Option 3: [Table view](/features/clients/client-list) inline edit**
- Click the stage cell
- Choose new stage
- Click outside to save

**Option 4: Bulk change ([table view](/features/clients/client-list))**
